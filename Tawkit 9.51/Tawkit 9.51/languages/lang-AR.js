const JS_eLang = {
  ...
  XX_TIMES_4:
    "و قم بتعديل الملف (/data/00/wtimes-00.000.js) لتناسب أوقات مسجدك",
  ...
  XX_WCSV_MESSAGE:
    "تفعيل الملف الشخصي لأوقات الصلاة والإقامة .<br>( JAMAAT TIMES ) قم بتعديل الملف (wcsv.js) في مجلد التطبيق.",
